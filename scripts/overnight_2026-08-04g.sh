...
set -u
cd "$(dirname "$0")/.."
L=logs/overnight/v8tune_2026-08-04.log
mkdir -p logs/overnight
: > "$L"
echo "=== START $(date -Is) ===" >> "$L"
.venv/bin/python scripts/eval_sweep.py sweep \
    --arms tf_trim_ev03_rc05,v8_nb120_mbb025,v8_nb105_mbb025,v8_nb112_mbb015 --seeds 3 >> "$L" 2>&1
...
for arm in ("tf_trim_ev03_rc05","v8_nb120_mbb025","v8_nb105_mbb025","v8_nb112_mbb015"):
    C=[];T=[];O=[]
