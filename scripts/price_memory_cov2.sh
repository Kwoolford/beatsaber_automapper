#!/usr/bin/env bash
# RE-RUN under STRICT_PARITY (2026-09-13x). The first run refuted --map-memory entirely on the
# idiom_coverage collapse, and that collapse was the vocabulary-blind parity repair, now fixed.
...
OUT=outputs/memory_cov2_2026-09-13
mkdir -p $OUT
